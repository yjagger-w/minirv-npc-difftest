# E6B post-expansion miniRV ISA gap audit
...
`ADD`, `ADDI`, `LUI`, `LW`, `LBU`, `SW`, `SB`, `JALR`, `EBREAK`, `AUIPC`, `BEQ`, `BNE`, `SLTIU`
...
|---|---|---|
| add | `add` 2, `addi` 18, `auipc` 8, `beq` 1, `bne` 2, `ebreak` 1, `jalr` 8, `lui` 2, `lw` 12, `sltiu` 1, `sw` 11 | `sub` 1 |
...
| fact | — | — |
| fib | `add` 1, `addi` 12, `auipc` 6, `beq` 1, `bne` 1, `ebreak` 1, `jalr` 6, `lui` 2, `lw` 6, `sltiu` 1, `sw` 5 | `sub` 1 |
| if-else | `addi` 27, `auipc` 6, `beq` 1, `bne` 1, `ebreak` 1, `jalr` 8, `lui` 2, `lw` 5, `sltiu` 1, `sw` 4 | `andi` 2, `blt` 6, `slt` 2, `sub` 3 |
| load-store | `add` 1, `addi` 24, `auipc` 14, `beq` 1, `bne` 3, `ebreak` 1, `jalr` 10, `lbu` 12, `lui` 2, `lw` 13, `sltiu` 6, `sw` 8 | `lh` 1, `lhu` 1, `or` 9, `sh` 1, `sll` 1, `slli` 10, `srli` 1, `sub` 6, `xori` 1 |
| max | `addi` 20, `auipc` 8, `beq` 1, `bne` 2, `ebreak` 1, `jalr` 8, `lui` 2, `lw` 12, `sltiu` 1, `sw` 11 | `bge` 2, `sub` 1 |
| min3 | `add` 1, `addi` 28, `auipc` 11, `beq` 1, `bne` 3, `ebreak` 1, `jalr` 9, `lui` 2, `lw` 17, `sltiu` 1, `sw` 14 | `bge` 4, `slli` 1, `sub` 1 |
| shift | `addi` 25, `auipc` 10, `beq` 1, `bne` 3, `ebreak` 1, `jalr` 7, `lui` 2, `lw` 13, `sltiu` 3, `sw` 8 | `sra` 1, `srl` 1, `srli` 1, `sub` 3 |
| string | — | — |
| sum | `add` 2, `addi` 10, `auipc` 2, `beq` 1, `bne` 1, `ebreak` 1, `jalr` 5, `lui` 3, `lw` 3, `sltiu` 1, `sw` 4 | — |
| switch | `add` 2, `addi` 19, `auipc` 6, `beq` 3, `ebreak` 1, `jalr` 8, `lui` 2, `lw` 6, `sltiu` 1, `sw` 4 | `bltu` 1, `jal` 1, `slli` 2, `sub` 1 |
...
This is the smallest observed unsupported-instruction set for any linked test (1 instruction(s)); it would unlock add, fib. Frequency and test coverage break equal-size ties.
